               ...
               <div class="row">
                  ...
                  <div class="col-md-8">
                     <h5>
                        ...
                        <b>Status:</b> <?php if($details->status == 'pending'): ?><a href="<?php echo route('vendors.status',$details->id); ?>" class="badge badge-primary">Approve</a><?php else: ?> <a href="#" class="badge badge-success">Active</a> <?php endif; ?><br>
                     </h5>
                  </div>
                  <div class="col-md-12">
                     <hr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/devint/tupange/admin.tupange.com/resources/views/modules/vendors/details.blade.php ENDPATH**/ ?>