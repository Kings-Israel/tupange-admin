               ...
               <div class="row">
                  ...
                  <div class="col-md-8">
                     <h5>
                        ...
                        <b>Name:</b> <?php echo $details->location; ?><br>
                     </h5>
                  </div>
                  <div class="col-md-12">
                     <hr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/devint/admin.tupange.com/resources/views/modules/vendors/details.blade.php ENDPATH**/ ?>