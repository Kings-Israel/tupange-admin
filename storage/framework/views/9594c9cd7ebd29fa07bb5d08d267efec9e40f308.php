<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
   ...
   <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
      ...
      <li class="nav-item <?php echo Nav::isResource('category'); ?>">
         <a href="<?php echo route('category.index'); ?>">
            <i class="far fa-dollar-sign"></i><span class="menu-title">Category</span>
         </a>
      </li>
...
<?php /**PATH /opt/lampp/htdocs/devint/admin.tupange.com/resources/views/partials/_menu.blade.php ENDPATH**/ ?>